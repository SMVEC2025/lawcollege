...
export default function ContactArea() {
  return (
    <section className="tp-contact-area tp-contact-p fix p-relative pt-150 pb-125">
      <div className="tp-contact-bg" ></div>
      <div className="tp-contact-bg" style={{ backgroundImage: "url(/assets/img/live/contact-bg.png)",opacity:'0.5',backgroundRepeat:"no-repeat" }}></div>
